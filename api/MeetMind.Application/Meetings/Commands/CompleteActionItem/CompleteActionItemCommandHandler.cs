...
public class CompleteActionItemCommandHandler : IRequestHandler<CompleteActionItemCommand, ActionItemResponse>
{
    private readonly IActionItemRepository _actionItemRepository;

    public CompleteActionItemCommandHandler(IActionItemRepository actionItemRepository)
    {
        _actionItemRepository = actionItemRepository;
    }

    public async Task<ActionItemResponse> Handle(CompleteActionItemCommand request, CancellationToken cancellationToken = default)
    {
